...
public class ListAdapter2 extends RecyclerView.Adapter<ListAdapter2.ViewHolder>{
    ...
    public ListAdapter2(LayoutInflater inflater, Context context, ArrayList<PostingDTO> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = inflater.inflate(R.layout.item_recommend_list2, parent, false);
