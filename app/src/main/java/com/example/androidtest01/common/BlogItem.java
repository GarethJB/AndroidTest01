...
public class BlogItem {
        ...
        list.add( new BlogDTO("산보", "EAT PRAY LOVE", "EAT", "초간단 발효 쌀피자 만들기", "3시간 전"
                ...
                , 2 , 3, 1));
        list.add( new BlogDTO("이랑", "이랑's HOUSE", "맛집탐방", "앤티크한 카페에서 공부 데이트", "2022. 11. 23."
